function createUserDataBuffer(userData) {
...
export function createUserDataString(userData) {
    // Use null terminators instead of tabs
    const userStr = `PIN=${userData.pin}\x00` +
...
//# sourceMappingURL=create-user-data-buffer.js.map